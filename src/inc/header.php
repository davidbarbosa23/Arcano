...
<html class="no-js" lang="en">
  ...
  <body>
    <?php if (basename(dirname($_SERVER['SCRIPT_FILENAME'])) != 'src') : ?>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light pl-sm-3 pl-md-5 pl-xl-6 pr-sm-3 pr-md-5 pr-xl-6">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
          	<?php if (basename(dirname($_SERVER['SCRIPT_FILENAME'])) == 'eventos') : ?>
            	<a href="<?= $uri['events'] ?>/calendar" class="nav-link text-light">Eventos</a>
          	<?php else: ?>
      ...
      <ul class="navbar-nav justify-content-end iconsArcanoNav">
        ...
        <li class="nav-item">
          <a href="#" class="nav-link custom-link shop text-center">
            <span>01</span>
          </a>
        </li>
      </ul>
